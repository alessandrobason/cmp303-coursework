...
// bool Tilemap::isColliding(const RectCollider &rect) const {
//     for(auto &r : rect_colliders) {
//         if(r.isColliding(rect)) return true;
//     }
//     for(auto &c : circ_colliders) {
//         if(c.isColliding(rect)) return true;
//     }

//     return false;
// }

// bool Tilemap::isColliding(const CircleCollider &circ) const {
//     for(auto &r : rect_colliders) {
//         if(r.isColliding(circ)) return true;
//     }
//     for(auto &c : circ_colliders) {
//         if(c.isColliding(circ)) return true;
//     }
...
Tilemap &Tilemap::operator=(Tilemap &&other) {
    ...
    // rect_colliders = std::move(other.rect_colliders);
    // circ_colliders = std::move(other.circ_colliders);
